<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/101.37.13.45/public/../application/admin/view/user/user_edit.html";i:1611219061;s:66:"/www/wwwroot/101.37.13.45/application/admin/view/public/baidu.html";i:1605245648;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body>
            ...
            <form class="layui-form"  action="javascript:edit();">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_customer_id" name="customer_id" required="" disabled="" lay-verify="id"
                        autocomplete="off" class="layui-input" value="<?php echo $info['customer_id']; ?>">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_customer_name" name="customer_name" required=""  disabled="" lay-verify="goodname"
                        autocomplete="off" class="layui-input" value="<?php echo $info['customer_name']; ?>">
                    </div>
                    <div class="layui-form-mid layui-word-aux">
                        <span class="x-red">*</span>不可修改
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" value="<?php echo $info['address']; ?>">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input"  value="<?php echo $info['phone']; ?>">
                    </div>
                </div>
    ...
    <script type="text/javascript">
        function edit(){
            ...
            var url="/index.php/admin/user/submit_edit/"+str+".html"
