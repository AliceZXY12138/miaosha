        ...
        <div class="page-content">
          <div class="content">
            ...
            <xblock>
                ...
                <span class="x-right" style="line-height:40px">共有数据：<?php echo $user_size; ?> 条</span>
            </xblock>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td-manage">
                            ...
                            <a title="编辑"  href="javascript:;" onclick="user_edit('编辑用户<?php echo $vo['customer_id']; ?>','<?php echo url("user_edit","id=$vo[customer_id]"); ?>',this,'600','500')"
                            class="ml-5" style="text-decoration:none">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
                           
                            <a title="删除" href="javascript:;" onclick="javascript:user_del(this,'<?php echo url("user_del","id=$vo[customer_id]"); ?>')"
