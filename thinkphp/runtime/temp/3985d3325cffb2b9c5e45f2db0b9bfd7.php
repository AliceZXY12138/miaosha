<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/101.37.13.45/public/../application/admin/view/goods/good_add.html";i:1611209386;s:66:"/www/wwwroot/101.37.13.45/application/admin/view/public/baidu.html";i:1605245648;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body>
            ...
            <form class="layui-form"  action="javascript:edit();">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_good_id" name="good_id" required="" lay-verify="id"
                ...
                <div class="layui-form-item" id="ssstatus">
                    ...
                    <div class="layui-input-inline">
                            <input type="radio" name="status" value="1" checked title="在售">
    ...
    <script type="text/javascript">
        function edit(){
            ...
            var url="/index.php/admin/goods/submit_add/"+str+".html"
