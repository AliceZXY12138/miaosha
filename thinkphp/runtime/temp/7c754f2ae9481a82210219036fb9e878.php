<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/www/wwwroot/101.37.13.45/public/../application/admin/view/staff/staff_edit.html";i:1611225102;s:66:"/www/wwwroot/101.37.13.45/application/admin/view/public/baidu.html";i:1605245648;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
            ...
            <form class="layui-form"  action="javascript:edit();">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" value="<?php echo $info['user_id']; ?>">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" value="<?php echo $info['username']; ?>">
                    </div>
                    <div class="layui-form-mid layui-word-aux">
                        <span class="x-red">*</span>不可修改
                    </div>
